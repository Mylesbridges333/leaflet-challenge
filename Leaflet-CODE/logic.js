// Store  API EP inside queryUrl
var queryUrl = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";

// Perform a GET request to the query URL
d3.json(queryUrl, function(data) {
  //after recieving a response, send the data.features object to the createFeatures function
...
function createFeatures(earthquakeData) {
  ...
  //Array to hold cicles
  var myCircleArray = new Array();

  // Loop through the cities array/// create one marker for each  object
...
//////-----------------------------------------------------------------------
  ...
  legend.onAdd = function (map) {
    ...
    var color = ["#00ccbc","#90eb9d","#f9d057","#f29e2e","#e76818","#d7191c"];
  	...
  	// loop through our density intervals///  label with a colored square 
